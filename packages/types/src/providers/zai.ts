...
export const mainlandZAiModels = {
	...
	"glm-5": {
		...
		cacheReadsPrice: 0.1,
		description:
			"GLM-5 is Zhipu's next-generation model with a 200k context window and built-in thinking capabilities. It delivers state-of-the-art reasoning, coding, and agentic performance.",
	},
	"glm-5-turbo": {
		maxTokens: 128_000,
		contextWindow: 200_000,
