...
export const internationalZAiModels = {
	...
	"glm-5.2": {
		...
		cacheReadsPrice: 0.11,
		description:
			"GLM-5.2 is Zhipu's next-generation model with a 202k context window and built-in thinking capabilities. It delivers state-of-the-art reasoning, coding, and agentic performance.",
	},	
	"glm-4.7-flash": {
		maxTokens: 16_384,
		contextWindow: 200_000,
...
export const mainlandZAiModels = {
	...
	"glm-5.2": {
		...
		cacheReadsPrice: 0.1,
		description:
			"GLM-5.2 is Zhipu's next-generation model with a 200k context window and built-in thinking capabilities. It delivers state-of-the-art reasoning, coding, and agentic performance.",
	},
	"glm-4.7-flash": {
		maxTokens: 16_384,
		contextWindow: 204_800,
